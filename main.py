...
def attack(char_name, char_class):
    ...
    if char_class == 'healer':
        ...
        return f'{char_name} нанёс урон противнику равный {damage}'
    return f'{char_name} не атаовал'


def defence(char_name, char_class):
    if char_class == 'warrior':
        damage = 0 + randint(5, 10)
...
def special(char_name, char_class):
    if char_class == 'warrior':
        var = 80 + 25
        return f'{char_name} применил специальное умение «Выносливость {var}»'
    if char_class == 'mage':
        var = 5 + 40
        return f'{char_name} применил специальное умение «Атака {var}»'
    if char_class == 'healer':
        var = 10 + 30
        return f'{char_name} применил специальное умение «Защита {var}»'
