...
class Character:
    ...
    def attack(self):
        ...
        return (f'{self.name} нанес урон, равный {value_attack}')
...
def choice_char_class(char_name: str) -> Character:
    """
    Возвращает строку строку с выбранным
    классом персонажа.
    """
...
def start_training(character):
    ...
    # chars = {
    #     'Warrior': f'{character.name}, ты Воитель — великий '
    #                f'мастер ближнего боя.',
    #     'Mage': f'{character.name}, ты Маг — превосходный укротитель стихий.',
    #     'Healer': f'{character.name}, ты Лекарь — чародей, '
    #               f'способный исцелять раны.'
    # }
    # print(chars[character.__class__.__name__])
    print(character)
